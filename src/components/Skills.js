...
const Skills = () => {
  return (
    <div name="skills" className="text-gray-700 w-full h-screen bg-[#4a6d88]">
      {/* Container */}
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-3 gap-4 text-center py-8">
          <div className="shadow-sm shadow-gray-500 rounded-lg hover:scale-105 duration-500 cursor-pointer py-3 bg-[#f2f2f3]">
            <img className="w-20 mx-auto" src={HTML} alt="HTML" />
            <p className="my-3">HTML</p>
          </div>
          <div className="shadow-sm shadow-gray-500 bg-[#f2f2f3] rounded-lg hover:scale-105 duration-500 cursor-pointer py-3">
