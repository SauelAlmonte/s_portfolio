...
const Skills = () => {
  return (
    <div name="skills" className="text-gray-700 w-full h-screen">
      {/* Container */}
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div>
          <p className="text-4xl font-bold inline border-b-4 py-1.5">
            Skills
          </p>
          <p className="pt-8">These are the technologies I've worked with</p>
        </div>
        <div className="w-full grid grid-cols-2 sm:grid-cols-3 gap-4 text-center py-8">
          <div className="shadow shadow-gray-500 rounded-lg hover:scale-105 duration-500 cursor-pointer py-3">
